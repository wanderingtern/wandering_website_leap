...
```bash
git remote add encore encore://wandering-tern-energy-audits-qix2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/wandering-tern-energy-audits-qix2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/wandering-tern-energy-audits-qix2/settings/integrations/github)
